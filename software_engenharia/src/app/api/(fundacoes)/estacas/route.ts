...
function calcCapAokiVelloso({ Nsd, diametro, tipo_estaca,
    spt, prof_apoio, fl, fp, espacamento }: IPropsEntradaEstaca): ResultadoCalculoEstaca[] {
...
export async function POST(request: NextRequest) {
    try {
        ...
        const { spt, Nsd, diametro, tipo_estaca, prof_apoio, fl, fp, espacamento } = resultado.data;

        const resultados = calcCapAokiVelloso({ spt, Nsd, diametro, tipo_estaca, prof_apoio, fl, fp, espacamento });
